...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_cybersecuritywithprivategpt-fb1a", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_cybersecuritywithprivategpt-fb1a"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
