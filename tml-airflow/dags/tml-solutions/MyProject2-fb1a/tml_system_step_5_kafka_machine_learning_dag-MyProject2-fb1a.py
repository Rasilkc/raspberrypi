...
@dag(dag_id="tml_system_step_5_kafka_machine_learning_dag_MyProject2-fb1a", default_args=default_args, tags=["tml_system_step_5_kafka_machine_learning_dag_MyProject2-fb1a"], schedule=None,catchup=False)
