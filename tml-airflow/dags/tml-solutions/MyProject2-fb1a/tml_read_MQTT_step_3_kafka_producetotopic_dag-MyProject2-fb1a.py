...
default_args = {
  ...
  'mqtt_broker' : 'http://279a12c82d19419bb92da465b42a71c6.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_MyProject2-fb1a", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_MyProject2-fb1a"], schedule=None,catchup=False)
